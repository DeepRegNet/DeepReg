...
class NiftiUnpairedUnlabeledDataLoader(UnpairedDataLoader, GeneratorDataLoader):
    def __init__(self,
                 data_dir_path: str, sample_label: (str, None), seed, image_shape: (list, tuple)):
        """
        ...
        """
        super(NiftiUnpairedUnlabeledDataLoader, self).__init__(image_shape=image_shape, sample_label=sample_label,
                                                               seed=seed)
