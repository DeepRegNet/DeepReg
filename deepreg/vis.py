...
def main(args=None):
    ...
    parser.add_argument("--fname", help="File name (with extension like .png, .jpeg, .gif, ...) to save visualisation to \nApplicable only if --mode 2 or --mode 3", type=str, default=None)
