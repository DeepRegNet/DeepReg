...
class DataLoader:
    ...
    def sample_image_label(self, moving_image: np.ndarray, fixed_image: np.ndarray,
                           ...
                           fixed_label: (np.ndarray, None), image_indices: list):
        '''
        ...
        :param image_indices : list
        '''
        self.validate_images_and_labels(moving_image, fixed_image, moving_label,
                                        fixed_label, image_indices)
        # unlabeled
...
class AbstractPairedDataLoader(DataLoader, ABC):
    ...
    def __init__(self, moving_image_shape: (list, tuple),
        ...
        """
        super(AbstractPairedDataLoader, self).__init__(num_indices=2,
                                                       **kwargs)
...
class AbstractUnpairedDataLoader(DataLoader, ABC):
    ...
    def __init__(self, image_shape: (list, tuple), **kwargs):
        ...
        """
        super(AbstractUnpairedDataLoader, self).__init__(num_indices=3,
                                                         **kwargs)
