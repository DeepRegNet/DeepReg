...
from deepreg.model.network.build import build_backbone, build_inputs
...
def build_model(moving_image_size, fixed_image_size, index_size, labeled, batch_size, tf_model_config, tf_loss_config):
