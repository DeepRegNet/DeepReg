import os
from os import listdir, system, remove, makedirs
...
for ds in data_splits:
    ...
    for f in files:
        ...
        mask[mask_tuple[0][0]:mask_tuple[0][1],mask_tuple[1][0]:mask_tuple[1][1],mask_tuple[2][0]:mask_tuple[2][1]] = 1
...
print('Labels have been one-hot encoding using a total of ' + str(num_labels) + ' labels.')
